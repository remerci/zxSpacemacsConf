...
(defcustom eim-wb-history-file "~/.spacemacs.d/layers/chinese/local/eim/wbx-history"
  "保存选择的历史记录"
  :type 'file
  :group 'eim-wb)

(defcustom eim-wb-user-file "~/.spacemacs.d/layers/chinese/local/eim/mywb.txt"
  "保存用户自造词"
  :type 'file
  :group 'eim-wb)
